...
fn prefunded_partial_rent() {
    ...
    assert!(charged < acc.lamports, "payer charged less than full rent (prefund covered the rest)");
    assert_eq!(charged, acc.lamports - prefund, "payer charged exactly rent - prefund");
}
